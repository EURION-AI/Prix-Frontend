...
import { CheckCircle2, Zap, Github, ArrowRight } from 'lucide-react'
      ...
      <div className="section-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="section-title text-5xl md:text-7xl mb-6 leading-[0.9]">
              Two clicks to <br />
            ...
            <div className="space-y-6">
              {steps.map((step, i) => (
                <div key={i} className="flex gap-4 group">
                  <div className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-primary transition-colors">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-glass-vibrant rounded-3xl p-1 shadow-2xl glow-pink overflow-hidden group">
              <div className="bg-background rounded-[22px] p-10 relative overflow-hidden">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-3 tracking-tight">GitHub Marketplace</h3>
                  <p className="text-white/40 text-sm mb-8 max-w-xs"><span className="text-primary font-bold">Prix</span> is a verified GitHub App. Your code never leaves the secure environment.</p>
